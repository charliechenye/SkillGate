...
it requires an npm package name to be published.
...
```bash
SKILLGATE_VERSION=v0.1.1 npx --yes github:charliechenye/SkillGate#v0 -- scan .
```
...
```bash
SKILLGATE_VERSION=v0.1.1 npx --yes github:charliechenye/SkillGate#FULL_COMMIT_SHA -- scan .
```
